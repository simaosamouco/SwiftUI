    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: false) {
            VStack(alignment: .center, spacing: 20) {
                ...
                Text("Discover and pick the perfect destination for your romantic Honeymooon!")
                    .lineLimit(nil)
                ...
                VStack(alignment: .center, spacing: 25) {
                    ...
                    GuideComponent(title: "Book", subtitle: "Tap the button", description: "Our selection of honeymoon is perfect setting for you to embark your new life together", icon: "checkmark.square")
                }
